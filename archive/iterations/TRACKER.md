...
| 28 | JGH fit: manuscript read as a national cliometric study; comparative cases confined to a coda; DiD confound over-weighted (external reader, 7 Sep 2026) | `resolved` | Reframed 7 Sep 2026: abstract and introduction open with Tvedt's comparative question; new §4.6 reads the Netherlands, Belgium, China and India against the British result at Maddison benchmarks (Table 6); DiD cut to §4.7 (~300 words); §5.4 restates the thesis as a matching rule; Elvin 1973 and Parthasarathi 2011 added. No estimates changed. Word count 12,450 incl. footnotes | 06 |
