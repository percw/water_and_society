...
1700, but Britain is where output, population and a canal network still
under construction run together year by year, with installed power at
benchmarks. The comparative cases can then be read through its result.
...
documented and, until recently, measured only in parts. Between the
Bridgewater Canal of 1761 and the opening of the Liverpool and
Manchester Railway in 1830, Parliament authorised roughly 165 canal
companies and the navigable network grew from about 1,400 miles of
improved river to some 4,000 miles of river and canal (Hadfield 1984;
Bogart 2014). The coal trade itself was older and larger than the
canals: the coastal trade from the Tyne and Wear to London was already
the largest bulk-freight flow in Europe in 1700, and Britain's coal
output had been rising for two centuries before the first canal was cut
(Hatcher 1993; Flinn 1984; Pollard 1980). What canals changed was inland
access. Priestley's survey of 1831 opens its account of the Bridgewater
Canal by noting that the Duke's ``primary object'' was ``to open his
valuable collieries at Worsley, and to supply the town of Manchester
with coal, at a much cheaper rate'' (Priestley 1831). Turnbull's
regional study made the same point: canals were built where coal was,
carried coal above all else, and the counties that acquired them saw
coal and population grow faster (Turnbull 1987).
